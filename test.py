...
parser.add_argument('--msmt17', action='store_true', help='if using msmt17 dataset')
...
gallery_cam, gallery_label = get_id(gallery_path, opt.msmt17)
query_cam, query_label = get_id(query_path, opt.msmt17)

if opt.multi:
    mquery_path = image_datasets['multi-query'].imgs
    mquery_cam, mquery_label = get_id(mquery_path, opt.msmt17)
